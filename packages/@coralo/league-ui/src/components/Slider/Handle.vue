...
export default {
  functional: true,
  render (h, { data: { staticClass, style } }) {
    return h('svg', {
      class: staticClass,
      style,
      attrs: {
      ...
      h('g', [
        ...
        h('path', {
          attrs: {
            fill: '#0E151D',
            d: 'M36.2,29.6l2.7,2.7L25.5,45.7l-2.1,2.1l2.1,2.1l13.3,13.5L36.3,66L18,47.8L36.2,29.6 M36.2,25.3L13.8,47.8 l22.5,22.5l6.8-6.8L27.6,47.8l15.6-15.6L36.2,25.3L36.2,25.3z'
          }
        })
      ]),
      h('g', [
        ...
        h('path', {
          attrs: {
            fill: '#0E151D',
            d: 'M60.1,29.5l18.2,18.2L59.5,66.5l-2.7-2.6l13.6-13.7l2.1-2.1L70.4,46L56.9,32.8L60.1,29.5 M60.1,25.3l-7,7.1 l-0.4,0.4l15.7,15.3L52.5,64l7.1,6.7l23-23L60.1,25.3L60.1,25.3z'
          }
        })
      ]),
      h('g', [
        h('polygon', {
          attrs: {
            fill: '#1E2328',
            points: '43.2,75.4 48,70.6 53.4,75.9 48.5,80.8'
          }
        }),
        h('path', {
          attrs: {
      ...
      h('g', [
        h('polygon', {
          attrs: {
            fill: '#1E2328',
            points: '42.7,20.6 48,15.3 53.4,20.7 48,26.1'
          }
        }),
        h('path', {
          attrs: {
