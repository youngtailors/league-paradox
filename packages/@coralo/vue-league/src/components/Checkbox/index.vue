...
.checkbox
  ...
  &:hover, &:focus
    ...
    .box
      .border
        ...
        border-image linear-gradient(to bottom, lcu-gold-border-color 50%, lighten(lcu-gold-border-color, 15%) 100%)
        border-image-slice 1

    .label
      color lighten(lcu-text-dark, 20%)
  ...
  .border
    ...
    border-color lcu-gold-border-color
  ...
  .check
    ...
    left 0
    display none
    color lighten(rgb(56.1%, 45.1%, 20%), 10%)
    font-size 0.9rem
